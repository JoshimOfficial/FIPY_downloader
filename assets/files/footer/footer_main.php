...
<footer class="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
    <div class="sm:flex sm:items-center sm:justify-between">
        <a href="<?php echo $webfixer;?>" class="flex items-center mb-4 sm:mb-0">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FIP Downloader</span>
        </a>
    ...
    <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">©<a href="<?php echo $webfixer;?>" class="hover:underline">FIP Downloader</a>. All Rights Reserved.
    </span>
</footer>
<?php 
}
