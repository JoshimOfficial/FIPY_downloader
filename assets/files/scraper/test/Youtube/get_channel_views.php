...
function yt_channel_views($channel) {
    ...
    function nice_views($n) {
        ...
        // now filter it;
        if ($n > 1000000000000) return array("decimal" => round(($n/1000000000000), 2), "thousand" => round(($n/100000000000), 2).'T');
        elseif ($n > 1000000000) return array("decimal" => round(($n/1000000000), 2), "thousand" => round(($n/100000000), 2).'B');
        elseif ($n > 1000000) return array("decimal" => round(($n/1000000), 2), "thousand" => round(($n/100000), 2).'M');
        elseif ($n > 1000) return array("decimal" => round(($n/1000), 2), "thousand" => round(($n/100), 2).'K');
